...
export default function NewDoctorPage() {
  ...
  const onSubmit = async (data: DoctorFormData) => {
    ...
    try {
      // Clean empty strings - Note: doctors are now created via invite system
      const cleanData = {
        ...data,
        phone: data.phone || null,
        approved: true  // Legacy doctors auto-approved, new system uses invites
      }
      ...
      let errorMessage = 'Erro ao criar médico'
      if (error?.message) {
        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Adicionar um novo profissional de saúde ao sistema
            </p>
          </div>
